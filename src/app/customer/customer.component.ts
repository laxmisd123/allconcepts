...
export class CustomerComponent implements OnInit {
  ...
  ngOnInit() {
    this.customer=this.fb.group({
      ...
      lastname:new FormControl(null,[Validators.required,Validators.minLength(3),this.checkLasttName.bind(this)]),
...
//  }
  ...
  checkLasttName(x:AbstractControl):{[y:string]:boolean}{
    let value=x.value;
    if (this.invalidName.indexOf(value)!==-1) {
